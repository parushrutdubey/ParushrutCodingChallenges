...
public class FlightTest {
	...
	// Testing constructors
		...
		public void testConstructor_departureBeforeArrival(){
			...
			assertEquals("Departure one minute before arrival, testing departure", expectedDeparture, c.dep);
			assertEquals("Departure one minute before arrival, testing arrival", expectedArrival, c.arr);
		}
		...
		public void testConstructor_departureSameAsArrival(){
			...
			assertNull("testing departure (expecting null)", c.dep);
			assertNull("testing arrival (expecting null)", c.arr);
		}
		...
		public void testConstructor_departureAfterArrival(){
			...
			//Date expectedArrival = null;
			assertNull("Departure one minute after arrival, testing departure (expecting null)", c.dep);
			assertNull("Departure one minute after arrival, testing arrival (expecting null)", c.arr);
		}
		...
		public void testConstructor_nullDepartureAndArrival(){
			...
			//Date expectedArrival = null;
			assertNull("testing departure", c.dep);
			assertNull("testing arrival", c.arr);
		}
		...
		public void testCopyConstructor(){
			...
			assertEquals("Testing departure", expectedDeparture, copy.dep);
			assertEquals("Testing arrival", expectedArrival, copy.arr);
		}
		...
		public void testCopyConstructor_nullDepartureAndArrival(){
			...
			assertNull("testing departure", p2.dep);
			assertNull("testing arrival", p2.arr);
		}
		@Test
